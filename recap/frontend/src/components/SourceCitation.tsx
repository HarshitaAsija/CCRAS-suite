...
export function SourceCitationCard({
  ...
  if (compact) {
    return (
      <Button
        variant="outline"
        size="sm"
        className="h-auto py-1.5 px-2.5 text-xs bg-white hover:bg-purple-50 hover:border-purple-300 transition-all"
        onClick={handleClick}
      >
        <FileText className="h-3 w-3 mr-1 text-purple-600 shrink-0" />
  ...
  return (
    <Card
      className="cursor-pointer transition-all duration-200 hover:shadow-md hover:border-purple-300 bg-linear-to-br from-white to-purple-50/20"
      onClick={handleClick}
    >
      <div className="p-2.5">
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            {citation.relevanceScore && (
              <Badge
                variant="outline"
                className="mt-1.5 text-xs bg-purple-100 text-purple-700 border-purple-200"
              >
