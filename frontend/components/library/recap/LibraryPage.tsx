...
// Hero illustration ΓÇö a lit bookshelf of varied, colour-graded
    ...
    <div className="relative w-full">
      ...
      >
        <defs>
          ...
          {/* real SVG glow ΓÇö soft blur merged under the crisp source shape */}
        ...
        {/* ΓöÇΓöÇ glowing knowledge core, floating above the shelf ΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ the bookshelf itself ΓöÇΓöÇ */}
...
// ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
// Page backdrop ΓÇö exactly three large, distinct library motifs
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      >
        ...
        {/* ΓöÇΓöÇ Motif 1: tall glowing bookshelf ΓÇö top-left margin ΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ Motif 2: research vignette ΓÇö stacked books with a magnifying glass ΓÇö right margin ΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ Motif 3: graduation cap with diploma scroll ΓÇö bottom-left margin ΓöÇΓöÇ */}
  ...
  <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded-md">
    <p className="text-sm text-red-800">{error}</p>
      ...
      <div className="relative bg-gradient-to-b from-white via-violet-50/60 to-violet-100/50 text-[#211d2e] overflow-hidden">
        ...
        {/* ΓöÇΓöÇ Main content ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        <div className="relative min-w-0">
          <div className="p-6 md:p-8 xl:p-12 2xl:p-16 max-w-[1680px] mx-auto">
            {/* ΓöÇΓöÇ Hero banner ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            {/* ΓöÇΓöÇ Stat cards ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            {/* ΓöÇΓöÇ Search + type filter + filters button ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            {filtersOpen && (
              <div className="flex items-center gap-3 mb-4 rounded-xl bg-[#faf8fd] border border-[#ece7f5] p-4">
                ...
                >
                  ...
                  <option value="title">Title (AΓÇôZ)</option>
                </select>
              </div>
            )}

            {/* ΓöÇΓöÇ Tab pills ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            {/* ΓöÇΓöÇ Content: collections + papers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            <div
              className={cn(
                'grid gap-6 xl:gap-8',
