...
// ─────────────────────────────────────────────────────────
// Page backdrop — three large library motifs
// ─────────────────────────────────────────────────────────
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 xl:gap-6 mb-6 xl:mb-8">
              <div className="rounded-2xl bg-white border border-[#ece7f5] p-5 xl:p-7 shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-3xl xl:text-4xl font-bold text-[#1c1830] leading-none">
                      {collections.length}
                    </div>
                        ...
                        {filteredCollections.map((collection) => (
                          ...
                          >
                            <div className="min-w-0">
                              <div className="text-sm font-medium text-[#2c2540] truncate">
                                {collection.name}
                              </div>
                              {collection.description && (
                                <div className="text-xs text-[#9691a8] truncate">
                                  {collection.description}
                                </div>
                              )}
                            </div>
                          ...
                          <div key={paper.id} className="py-4 first:pt-0 last:pb-0 group">
                            <div className="flex items-start gap-4">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {paper.abstract && (
                                  <p className="text-xs text-[#b3acc4] mt-1 line-clamp-2">
                                    {paper.abstract}
                                  </p>
                                )}
                                {paper.annotations && (
